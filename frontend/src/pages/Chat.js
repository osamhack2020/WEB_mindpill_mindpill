...
ChatLog.propTypes = {
    ...
    myLog: PropTypes.bool.isRequired,
}

class CurrentChatRoom extends React.Component {
        ...
        chatLogs: [
            {
                ...
                text: '이것은 테스트 텍스트입니다세요. 이것은 테스트 텍스트입니다이것은 테스트 텍스트입니다세요. 이것은 테스트 텍스트입니다이것은 테스트 텍스트입니다세요. 이것은 테스트 텍스트입니다',
                timestamp: '10:10 am',
                myLog: true,
            }, {
                text: '안녕하세요. 이것은 상대방 테스트 텍스트입니다안녕하세요. 이것은 상대방 테스트 텍스트입니다안녕하세요. 이것은 상대방 테스트 텍스트입니다',
                timestamp: '10:12 am',
                myLog: false,
            }, {
                text: '이것은 테스트 텍스트입니다세요. 이것은 테스트 텍스트입니다이것은 테스트 텍스트입니다세요. 이것은 테스트 텍스트입니다이것은 테스트 텍스트입니다세요. 이것은 테스트 텍스트입니다',
        ...
        return (
            <div className='current-chatroom expand'>
                ...
                <div className='chat-input'>
                    ...
                    <textarea type='text' placeholder='대화를 입력하세요.' rows='2'/>
                </div>
